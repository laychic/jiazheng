    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="预约备注" prop="yuyuebeizhu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yuyuebeizhu" label="预约备注" prop="yuyuebeizhu">
                    <span v-html="ruleForm.yuyuebeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yuyuebeizhu = this.ruleForm.yuyuebeizhu.replace(reg,'../../../springbootc90g5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
