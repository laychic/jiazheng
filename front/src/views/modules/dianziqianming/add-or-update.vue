<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.dianziqianming" label="电子签名" prop="dianziqianming">
          <file-upload
          tip="点击上传电子签名"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.dianziqianming?ruleForm.dianziqianming:''"
          @change="dianziqianmingUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.dianziqianming" label="电子签名" prop="dianziqianming">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.dianziqianming.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="签订日期" prop="qiandingriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiandingriqi" label="签订日期" prop="qiandingriqi">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="有效期" prop="youxiaoqi">
              <el-input v-model="ruleForm.youxiaoqi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="雇员账号" prop="guyuanzhanghao">
          <el-input v-model="ruleForm.guyuanzhanghao" 
              placeholder="雇员账号" clearable  :readonly="ro.guyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="雇员账号" prop="guyuanzhanghao">
              <el-input v-model="ruleForm.guyuanzhanghao" 
                placeholder="雇员账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="雇员姓名" prop="guyuanxingming">
          <el-input v-model="ruleForm.guyuanxingming" 
              placeholder="雇员姓名" clearable  :readonly="ro.guyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="雇员姓名" prop="guyuanxingming">
              <el-input v-model="ruleForm.guyuanxingming" 
                placeholder="雇员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	neirong : false,
	dianziqianming : false,
	qiandingriqi : false,
	youxiaoqi : false,
	zhanghao : false,
	xingming : false,
	shouji : false,
	guyuanzhanghao : false,
	guyuanxingming : false,
	lianxidianhua : false,
      },
      ruleForm: {
        xiangmumingcheng: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirong = true;
          ...
          if(o=='dianziqianming'){
            this.ruleForm.dianziqianming = obj[o];
	    this.ro.dianziqianming = true;
            continue;
          }
          if(o=='qiandingriqi'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='guyuanzhanghao'){
            this.ruleForm.guyuanzhanghao = obj[o];
	    this.ro.guyuanzhanghao = true;
            continue;
          }
          if(o=='guyuanxingming'){
            this.ruleForm.guyuanxingming = obj[o];
	    this.ro.guyuanxingming = true;
            continue;
          }
          if(o=='lianxidianhua'){
      ...
      this.$http({
		...
		if(json.guyuanzhanghao!=''&&json.guyuanzhanghao){
                this.ruleForm.guyuanzhanghao = json.guyuanzhanghao
	    		this.ro.guyuanzhanghao = true;
		}
		if(json.guyuanxingming!=''&&json.guyuanxingming){
                this.ruleForm.guyuanxingming = json.guyuanxingming
	    		this.ro.guyuanxingming = true;
		}
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springbootc90g5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.dianziqianming!=null) {
		this.ruleForm.dianziqianming = this.ruleForm.dianziqianming.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dianziqianming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dianziqianmingCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    dianziqianmingUploadChange(fileUrls) {
	this.ruleForm.dianziqianming = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
