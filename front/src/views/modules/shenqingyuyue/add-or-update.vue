    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="申请备注" prop="shenqingbeizhu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shenqingbeizhu" label="申请备注" prop="shenqingbeizhu">
                    <span v-html="ruleForm.shenqingbeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shenqingbeizhu = this.ruleForm.shenqingbeizhu.replace(reg,'../../../springbootc90g5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shenqingyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shenqingyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
